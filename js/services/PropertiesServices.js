...
export const getPropertiesOnForm = async(page = 1, limit=10, realtorId = 0, statusId = 1, companyId = 1, operationType="", typeOfProperty="", region="", commune="", min_price=0, max_price=0, bathrooms=0, bedrooms=0, surface_m2=0,covered_parking_lots=0) => {
const _page = `${page}`;
const _limit = `${limit}`;
