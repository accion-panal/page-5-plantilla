...
export default async function apiCallMap() {
    ...
    const promiseMap = new Promise(
        ...
        data.map(data => {    
                ...
                <br>
                <a href="/detalle_propiedad.html?${data.id}&realtorId=${realtorId}&statusId=${1}&companyId=${companyId}" name="VerDetalle" target="_blank" class="more d-flex align-items-center float-start">
