        ...
        `<li class="splide__slide" >	 
            <div class="item" style="padding:1rem">
                <div class="media-entry" style="margin:0 10px 0 0;">
                    <a href="/detalle_propiedad.html?${filtrado.id}&statusId=${1}&companyId=${companyId}" target="_blank">
                    ...
                    <div class="bg-white m-body">
                        ...
                        <h3 class="mt-3"><a href="/detalle_propiedad.html?${filtrado.id}&statusId=${1}&companyId=${companyId}" target="_blank">${filtrado.title}</a></h3>
                        ...
                        <a href="/detalle_propiedad.html?${filtrado.id}&statusId=${1}&companyId=${companyId}" target="_blank" class="more d-flex align-items-center float-start">
